	...
	overrides: [
		{
			...
			rules: {
				...
				// RIPPED FROM WET's SCSS settings... with SCSS-specific properties commented-out
				...
				/*
				TODOS:
				-What is GCWeb doing for this vs WET?
				-How much of these null overrides are actually relevant to life events?
				-Are many of these useless baggage from WET/GCWeb's stone-age plugins or dependencies? Can I get rid of many of them?
				-Add more devDependencies
				-Verify devDependencies versions vs WET
				-Fix linting failures
				-Move into separate branch after my other pending PRs get merged (testing in a PR branch atm so that ESLint can ding any flaws in my stylelint config file)
				*/
			}
		}
	]
